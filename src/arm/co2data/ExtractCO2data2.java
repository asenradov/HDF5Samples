...
public class ExtractCO2data2 {
	...
	List<CO2data> occurrencesToList(Document document) {
		...
		String DATASETNAME_CO2FLUX = "co2_flux";
		String DATASETNAME_CO2 = "co2_molar_density";
		String VARIANCE_CO2 = "co2_flux_variance";
		String DATASETNAME_PRE = "air_pressure";	
		String DATASETNAME_TEMP = "air_temperature";
		...
		String DATASETNAME_WIND_DIR_PHI = "pitch";
		String DATASETNAME_TIME = "base_time";
		String DATASETNAME_TIME_OFFSET = "time_offset";
		String DATASETNAME_H = "sensible_heat_flux";
		String DATASETNAME_LE = "latent_heat_flux";
		String DATASETNAME_USTAR = "friction_velocity";
...
//								wind_dir_horiz_ii.getFloatNext(),wind_dir_theta_ii.getFloatNext(),wind_dir_phi_ii.getFloatNext())));
				...
				listOfPoints.add(new CO2data(get_date(date),co2flux_ii.getFloatNext(),co2_ii.getFloatNext(),
						largeCO2Variance(co2_ii.getFloatCurrent(),var_co2_ii.getFloatNext()),h2o_ii.getFloatNext(),
						false,getTemp(temperature_ii.getFloatNext()),false, getKPa(presure_ii.getFloatNext()),new WindArm(wind_speed_ii.getFloatNext(),false,
								wind_dir_horiz_ii.getFloatNext(),wind_dir_theta_ii.getFloatNext(),wind_dir_phi_ii.getFloatNext()),
...
//						dry_air_temp);				
	...
	private float getKPa(float pressure) {
		float result = 0;
	...
	public static void main(String[] args) throws Exception {
		...
		ExtractCO2data2 extractCO2data = new ExtractCO2data2();
